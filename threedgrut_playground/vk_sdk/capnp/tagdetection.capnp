...
struct AprilGrid {
    startId @0 :UInt32; # if std::numeric_limits<uint32_t>::max() is detected, use startIds instead
    ...
    startIds @8 :List(UInt32); # augment @0 startId, for keeping @0 backward compatible
}
