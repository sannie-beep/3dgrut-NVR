...
struct Flow2d {
    ...
    radial @2 :Float32; # radial in radian, from the positive z-axis (range 0 ~ pi)
    azimuth @3 :Float32; # azimuth in radian, from the positive y-axis (v axis), counter clockwise (range -pi ~ pi)
